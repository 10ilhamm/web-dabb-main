...
<section class="vt-rooms-section">
    <div class="container">
        <h2 class="vt-section-title">Pilih Buku</h2>
        <p class="vt-section-sub">Klik salah satu buku di bawah untuk mulai membaca</p>
