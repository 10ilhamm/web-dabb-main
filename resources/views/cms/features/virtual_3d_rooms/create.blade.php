...
@section('breadcrumb_items')
    ...
    <span class="text-gray-300">/</span>
    <span class="text-gray-400">{{ __('cms.virtual_3d_rooms.breadcrumb_create') }}</span>
@endsection
        ...
        <div class="space-y-6" style="width: 38%; min-width: 350px; flex-shrink: 0;">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">{{ __('cms.virtual_3d_rooms.label_desc') }} <span class="text-red-500">*</span></label>
