                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <button @click="deleteModal = { open: true, id: {{ $book->id }}, name: '{{ addslashes($book->title) }}' }"
                                    class="inline-flex items-center justify-center w-8 h-8 bg-red-500 hover:bg-red-600 text-white rounded-md transition-colors" title="Hapus Buku">
    ...
    <div x-show="deleteModal.open" x-cloak
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm z-[9999] p-6"
            ...
            <div class="flex flex-col items-center text-center gap-4">
                ...
                <div>
                    <h3 class="text-base font-semibold text-gray-800">Hapus Buku</h3>
                    <p class="text-sm text-gray-500 mt-1">
                        Yakin ingin menghapus buku <strong x-text="deleteModal.name" class="text-gray-700"></strong>? Semua halaman juga akan dihapus.
                    </p>
                </div>
