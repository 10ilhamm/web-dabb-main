...
@section('breadcrumb_items')
    ...
    <span class="text-gray-300">/</span>
    <a href="{{ route('cms.features.virtual_books.pages.index', [$feature, $book]) }}" class="text-gray-400 hover:text-gray-600 transition-colors">{{ __('cms.virtual_book_pages.breadcrumb_list') }}</a>
    <span class="text-gray-300">/</span>
    <span class="text-gray-400">{{ __('cms.virtual_book_pages.breadcrumb_edit') }}</span>
@endsection
...
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-800">{{ __('cms.virtual_book_pages.edit_title', ['name' => $virtualBookPage->title ?: __('cms.virtual_book_pages.new_label', ['number' => $virtualBookPage->order])]) }}</h1>
    ...
    <div class="flex gap-6 items-start" style="flex-wrap: nowrap;">
        ...
        <div class="space-y-6" style="width: 38%; min-width: 380px; flex-shrink: 0;">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                <h3 class="text-sm font-semibold text-gray-800 mb-4">{{ __('cms.virtual_book_pages.form.images_title') }}</h3>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('cms.virtual_book_pages.form.current_images') }}</label>
                        <div class="image-thumbnails" id="existingThumbnails">
                            ...
                            <div class="image-thumbnail">
                                ...
                                <span class="existing-label">{{ __('cms.virtual_book_pages.form.existing_label') }}</span>
                        ...
                        <label class="flex items-center mt-2">
                            ...
                            <span class="ml-2 text-sm text-gray-500">{{ __('cms.virtual_book_pages.form.remove_all_images') }}</span>
                        </label>
                    </div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('cms.virtual_book_pages.form.upload_new_images') }}</label>
                        ...
                        <p class="text-xs text-gray-500 mt-1.5">{{ __('cms.virtual_book_pages.form.upload_new_images_help') }}</p>
                    </div>
            ...
            <!-- Page Information -->
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                <h3 class="text-sm font-semibold text-gray-800 mb-4">{{ __('cms.virtual_book_pages.form.page_info') }}</h3>

                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">{{ __('cms.virtual_book_pages.form.title') }}</label>
                        <input type="text" name="title" id="pageTitleInput" value="{{ old('title', $virtualBookPage->title) }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm" placeholder="{{ __('cms.virtual_book_pages.form.title_placeholder') }}" oninput="updatePreview()">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">{{ __('cms.virtual_book_pages.form.content') }}</label>
                        <textarea name="content" id="pageContentInput" rows="6" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm" placeholder="{{ __('cms.virtual_book_pages.form.content_placeholder') }}" oninput="updatePreview()">{{ old('content', $virtualBookPage->content) }}</textarea>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('cms.virtual_book_pages.form.image_size') }}</label>
                        ...
                        <p class="text-xs text-gray-500 mt-1">{{ __('cms.virtual_book_pages.form.image_size_help') }}</p>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">{{ __('cms.virtual_book_pages.form.order') }} <span class="text-red-500">*</span></label>
            ...
            <!-- Thumbnail Section -->
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                <h3 class="text-sm font-semibold text-gray-800 mb-4">{{ __('cms.virtual_book_pages.form.thumbnail_title') }}</h3>

                <div class="space-y-4">
                    @if($virtualBookPage->thumbnail)
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('cms.virtual_book_pages.form.current_thumbnail') }}</label>
                        ...
                        <label class="flex items-center mt-2">
                            ...
                            <span class="ml-2 text-sm text-gray-500">{{ __('cms.virtual_book_pages.form.remove_thumbnail') }}</span>
                        </label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('cms.virtual_book_pages.form.upload_new_thumbnail') }}</label>
                        ...
                        <div id="thumbnailPreviewContainer" class="mt-2 hidden">
                            <p class="text-xs text-gray-500 mb-1">{{ __('cms.virtual_book_pages.form.thumbnail_new_will_save') }}</p>
                            <img id="thumbnailPreview" class="w-24 h-32 object-cover rounded-lg border border-gray-200" alt="Thumbnail Preview">
                            <button type="button" id="removeThumbnail" class="mt-1 text-xs text-red-500 hover:text-red-700">{{ __('cms.virtual_book_pages.form.cancel_remove') }}</button>
                        </div>
                        ...
                        <p class="text-xs text-gray-500 mt-1.5">{{ __('cms.virtual_book_pages.form.generate_help') }}</p>
                    </div>
                </div>
            </div>
        ...
        <div class="flex-1" style="width: 62%;">
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 sticky top-6">
                <h3 class="text-sm font-semibold text-gray-800 mb-1">{{ __('cms.virtual_book_pages.preview_title') }}</h3>
