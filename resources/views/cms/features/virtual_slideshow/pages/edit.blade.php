                ...
                files.forEach(function(file, i) {
                    ...
                    reader.onload = function(e) {
                        ...
                        wrap.innerHTML = '<img src="' + e.target.result +
                            '" style="height:80px;width:80px;object-fit:cover;border-radius:8px;border:1px solid #e5e7eb;" alt="">';
                    ...
                    row.innerHTML = '<label class="form-label" style="margin-bottom:4px;">Gambar baru ' + (
                            i + 1) + '</label>' +
                        '<input type="text" name="info_popup_images[' + idx +
                        ']" class="form-input" placeholder="Keterangan gambar ' + (i + 1) + ' baru...">';
