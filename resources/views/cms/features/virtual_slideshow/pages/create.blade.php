    ...
    <div class="space-y-6">
        ...
        <form
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-4 mt-4 section-panel active"
                ...
                <div id="infoPopupImageArea">
                    ...
                    <div id="infoPopupRows" class="space-y-2">
                        <p class="text-xs text-gray-400 italic" id="noImagesHint">Upload gambar dulu untuk mengisi
                            keterangan popup.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-4 mt-4 section-panel"
                ...
                <div>
                    <label class="form-label">URL Video <span class="text-gray-400 text-xs">(YouTube, atau URL
                            .mp4)</span></label>
        ...
        (function() {
            ...
            window.previewImages = function(input) {
                ...
                files.forEach(function(file, idx) {
                    ...
                    row.innerHTML = '<label class="form-label" style="margin-bottom:4px;">Gambar ' + (idx +
                            1) + '</label>' +
                        '<input type="text" name="info_popup_images[' + idx +
                        ']" class="form-input" placeholder="Keterangan gambar ' + (idx + 1) +
                        ' (opsional)...">';
